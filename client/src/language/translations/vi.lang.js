export default {
  ...
  TXT_SHOP_LIST: "Danh sách nhà hàng",
  TXT_REGISTER_SHOP: "Đăng ký nhà hàng",
  TXT_PROFILE: "Thông tin cá nhân",
  TXT_ID: "ID",
  TXT_SHOP_NAME: "Tên nhà hàng",
  ...
  TXT_SHOP_INFORMATION: "Thông tin nhà hàng",
