...
const DialogIteam = ({ id, nameCategory, descriptionCategory, priceCategory, srcCategory }) => {
    ...
    const [formChange, setFormChange] = useState({
        ...
        price: priceCategory,
        src: "https://scontent-hkg4-1.xx.fbcdn.net/v/t1.0-9/122136486_1728914547265383_8975641410850883114_n.jpg?_nc_cat=103&ccb=2&_nc_sid=730e14&_nc_ohc=TPWQ6vrKkZoAX8g5ze0&_nc_ht=scontent-hkg4-1.xx&oh=ef07225c41df92e68e312b3766537a8d&oe=5FD01F14",
    });
    ...
    <Box className={classes.boxPara}>
        ...
        >
            <form onSubmit={onSubmit}>
                <Box style={{backgroundImage: `url(${formChange.src})`,}} className={classes.dialogTitleBox}>
                ...
                <DialogActions>
                    <Box className={classes.boxButton}>
                        <ButtonBox nameButton={`Thêm vào giỏ hàng - ${formChange.price}`} onClick={onSubmit} typeButton={"submit"}></ButtonBox>
                    </Box>
                </DialogActions>
            </form>
        </Dialog>
