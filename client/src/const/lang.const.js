...
export const TXT_RESTAURANT_LIST = "TXT_RESTAURANT_LIST";
export const TXT_REGISTER_RESTAURANT = "TXT_REGISTER_RESTAURANT";
export const TXT_PROFILE = "TXT_PROFILE";
export const TXT_ID = "TXT_ID";
export const TXT_RESTAURANT_NAME = "TXT_RESTAURANT_NAME";
...
export const TXT_RESTAURANT_INFORMATION = "TXT_RESTAURANT_INFORMATION";
...
export const TXT_TYPE_RESTAURANT = "TXT_TYPE_RESTAURANT";
...
export const TXT_RESTAURANT_ADMIN = "TXT_RESTAURANT_ADMIN";
...
export const ARR_ADMIN_ROLE = [TXT_RESTAURANT_ADMIN, TXT_ADMIN];
export const ARR_RESTAURANT_STATE = [
  TXT_PENDING,
  TXT_DOING,
  TXT_SUCCESS,
  TXT_CANCEL,
