...
import { makeStyles, useTheme, useMediaQuery, IconButton, Box } from "@material-ui/core";
import { Store, AddCircle, Menu, AccountBox } from "@material-ui/icons";
    ...
    <main className={classes.main}>
      {
        isBreakPoint
          ...
          isBar && <Sidebar listSidebar={listSidebar} children={children} isTop={true} />
      }
